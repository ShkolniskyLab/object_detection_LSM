...
function object_detection_simulation(img_sz,obj_sz,objects_density,num_of_basis_functions,delta,alpha,test_fun,num_of_exp,gpu_use,paralell_com,SNR_lst,output_folder_figs)
...
rand_idx_basis = randperm(max(100,num_of_basis_functions),num_of_basis_functions); % choose randomly basis functions
...
for l = 1:length(SNR_lst)
    ...
    % Make dirs for figs
    output_folder_bh= [output_folder_figs,'figs for ',str_test,'/bh/snr',num2str(SNR)];                                              
    output_folder_bon= [output_folder_figs,'figs for ',str_test,'/bon/snr',num2str(SNR)];
    output_folder= [output_folder_figs,'figs for ',str_test,'/gen/snr',num2str(SNR)];   
